...
$(document).ready(function () { 
    ...
    $.ajax({
        type: "POST",                                              
        url: "http://localhost:8080/api/sala/prikaz",                 
        dataType: "json",
        ...
        success: function (res) {
            for (i = 0; i < res.length; i++) {                      
                ...
                row += "<td class=\"newCell center\">" + res[i].kapacitet + "</td>";
                row += "<td class=\"newCell center\">" + res[i].oznakaSale + "</td>";
...
$(document).on('click', '#izmena', function () {
    ...
    window.location.href = "izmena-sale.html"
